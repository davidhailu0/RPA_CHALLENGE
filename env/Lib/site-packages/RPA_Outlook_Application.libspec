...
<keywordspec name="RPA.Outlook.Application" type="LIBRARY" format="REST" scope="GLOBAL" generated="2023-12-18T19:49:12+00:00" specversion="5" source="./RPA/Outlook/Application.py" lineno="10">
<version/>
...
<kw name="Mark Email As Read" lineno="383">
...
<kw name="Move Emails" lineno="412">
...
<kw name="Save Email Attachments" lineno="340">
...
<kw name="Send Email" lineno="70">
<arguments repr="recipients: str | List[str], subject: str, body: str, html_body: bool = False, attachments: str | List[str] | None = None, save_as_draft: bool = False, cc_recipients: str | List[str] | None = None, bcc_recipients: str | List[str] | None = None">
...
<kw name="Wait For Email" lineno="193">
